...
#define lpNSLog(fmt, ...) ( (void) lplog_c_printf_v1( LOGPOINT_FLAGS_DEBUG | LOGPOINT_NSSTRING, "NSLog", kLogPointKeysNone, kLogPointLabelNone, kLogPointFormatInfoNone, fmt, ## __VA_ARGS__ ) )
/* (?) lpNSLogv */
